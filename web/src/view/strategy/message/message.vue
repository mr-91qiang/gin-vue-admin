  ...
  <div>
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="内容" prop="content">
         <el-input v-model="searchInfo.content" placeholder="搜索条件" />
            ...
            <el-select v-model="searchInfo.all" clearable placeholder="请选择">
                <el-option
                    key="true"
                    label="是"
                    value="true">
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="strategy_Message" />
            <ExportExcel  template-id="strategy_Message" />
            <ImportExcel  template-id="strategy_Message" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="主题" prop="title" width="120" />
          <el-table-column align="left" label="内容" prop="content" width="120" />
          <el-table-column label="发送人集合" prop="sendList" width="200">
              <template #default="scope">
                  [JSON]
              </template>
          </el-table-column>
        <el-table-column align="left" label="是否所有人" prop="all" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.all) }}</template>
        </el-table-column>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="发送人集合">
                        {{ detailFrom.sendList }}
                    </el-descriptions-item>
                    <el-descriptions-item label="是否所有人">
                        {{ detailFrom.all }}
                    </el-descriptions-item>
            </el-descriptions>
        </el-drawer>
